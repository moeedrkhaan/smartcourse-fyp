...
class AuthHandler:
    ...
    def register_user(self, email: str, username: str, password: str) -> Tuple[bool, str, Optional[int]]:
        ...
        if not re.fullmatch(r'[A-Za-z0-9](?:[A-Za-z0-9._]*[A-Za-z0-9])?', username):
            return False, "Username can only contain letters, numbers, dot (.) and underscore (_), and cannot start or end with dot/underscore", None
