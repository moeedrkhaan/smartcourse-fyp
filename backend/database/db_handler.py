...
class DatabaseHandler:
    ...
    def get_search_history(self, user_id: Optional[int] = None, limit: int = 50) -> List[Dict]:
        ...
        Args:
            user_id: User ID (None for all users - guest mode)
    ...
    def save_recommendation(
        ...
        cursor.execute('''
            ...
            (course_id, course_title, course_provider, query, model, relevance_score, user_id)
            VALUES (?, ?, ?, ?, ?, ?, ?)
        ''', (course_id, course_title, course_provider, query, model, relevance_score, user_id))
    ...
    def get_saved_recommendations(self, user_id: Optional[int] = None, limit: int = 100) -> List[Dict]:
        """
    ...
    def delete_search_history(self, history_id: int, user_id: Optional[int] = None) -> bool:
        """
    ...
    def delete_saved_recommendation(self, saved_id: int, user_id: Optional[int] = None) -> bool:
        """
